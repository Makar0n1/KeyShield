...
6. [Процесс сделки](#процесс-сделки)
7. [Multisig кошельки](#multisig-кошельки)
8. [Система комиссий](#система-комиссий)
9. [Партнёрская программа](#партнёрская-программа)
...
- **Система споров** — арбитраж с доказательствами
- **Партнёрская программа** — реферальные ссылки с аналитикой
...
│   │   ├── deal.js         # Управление сделкой
│   │   ├── disputes.js     # Споры
│   │   └── wallet.js       # Кошелёк пользователя
...
Доступен по адресу `http://localhost:3001/admin`
