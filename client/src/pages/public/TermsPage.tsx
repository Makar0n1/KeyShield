  ...
  return (
    <>
      ...
      <Section title="4. Создание и выполнение сделок">
        ...
        />
        <Paragraph>4.3. Для любой транзакции требуется 2 из 3 подписей. Это означает, что:</Paragraph>
        <List
          items={[
        ...
        />
        <Paragraph>4.4. Минимальная сумма сделки: 50 USDT.</Paragraph>
        <Paragraph>4.5. У каждого пользователя может быть только одна активная сделка одновременно.</Paragraph>
        <Paragraph>4.6. Обе стороны должны быть зарегистрированы в боте (отправили /start).</Paragraph>
      </Section>
      ...
      <Section title="8. Система банов">
        ...
        />
        <Paragraph>8.3. Обжалование бана: @mamlyga в Telegram</Paragraph>
      </Section>
      ...
      <Section title="10. Безопасность">
        <Paragraph>
          10.1. Мы применяем современные технологии для защиты multisig-кошельков и ключей.
        </Paragraph>
        <Paragraph>
          10.2. Приватные ключи хранятся в зашифрованном виде в защищенной базе данных.
        </Paragraph>
        <Paragraph>10.3. Пользователь несет ответственность за:</Paragraph>
        <List
          items={[
        ...
        />
        <Paragraph>
          10.4. НИКОГДА не сообщайте свои приватные ключи третьим лицам, включая поддержку Сервиса.
        </Paragraph>
      </Section>
