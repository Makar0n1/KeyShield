  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ background: 'var(--p-bg)', color: 'var(--p-text)' }}>
        ...
        {/* Desktop Sidebar */}
        <aside
          className="fixed top-0 left-0 z-50 h-full w-64 hidden lg:flex lg:flex-col bg-dark-lighter"
          style={{ borderRight: '1px solid var(--p-chrome-border)' }}
        >
          {/* Logo */}
        ...
        <div className="lg:pl-64">
          {/* Top header */}
          <header
            className="sticky top-0 z-30 h-14 lg:h-16 bg-dark-lighter"
            style={{ borderBottom: '1px solid var(--p-chrome-border)' }}
          >
            <div className="h-full px-4 flex items-center justify-between">
              ...
              <div className="ml-auto flex items-center gap-2">
                ...
                <button
                  onClick={toggle}
                  className="p-2 rounded-lg text-muted hover:text-white hover:bg-dark-light transition-colors"
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-gray-300 hover:bg-dark-light transition-colors"
                  >
                    ...
                    <span className="hidden sm:block text-sm text-gray-300">{platform?.name}</span>
                  ...
                  {dropdownOpen && (
                    <>
                      ...
                      <div
                        className="absolute right-0 mt-2 w-48 bg-dark-lighter border border-border rounded-lg shadow-xl z-50 overflow-hidden"
                      >
                        <NavLink
                          to="/partner/settings"
                          onClick={() => setDropdownOpen(false)}
                          className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-300 hover:bg-dark-light"
                        >
                          <Settings size={15} />
                          Настройки
                        </NavLink>
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-4 py-2.5 text-sm text-red-400 hover:bg-dark-light"
                        >
                          <LogOut size={15} />
                          Выйти
                        </button>
        ...
        {/* Mobile Tab Bar */}
        <nav
          className="fixed bottom-0 left-0 right-0 z-40 lg:hidden safe-bottom bg-dark-lighter"
          style={{ borderTop: '1px solid var(--p-chrome-border)' }}
        >
