...
<head>
  ...
  <link rel="preload" href="/css/style.css?v=26" as="style" onload="this.onload=null;this.rel='stylesheet'">
  <link rel="preload" href="/css/blog.css?v=26" as="style" onload="this.onload=null;this.rel='stylesheet'">
  <noscript>
  ...
  try {
    ...
    const schemas = [
      ...
      },
      {
        ...
        'url': tag.canonical || `${SITE_URL}/tag/${tag.slug}`
      }
    ];
    ...
    res.send(renderPage({
      ...
      description: tag.seoDescription || `Статьи с тегом ${tag.name}`,
      canonical: normalizeCanonical(tag.canonical, `${SITE_URL}/tag/${tag.slug}`),
